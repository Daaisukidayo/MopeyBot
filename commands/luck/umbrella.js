module.exports = ({
    ...
    $sendMessage[$channelID;
        $color[$get[clr]]
        $description[### $randomText[You were walking across the ocean and saw $var[desc];You were wandering around the ocean and spotted $var[desc];You stumbled upon $var[desc] while exploring;You were gliding across the ocean when you found $var[desc];You discovered $var[desc] while roaming the ocean;You were cruising through the wild and noticed $var[desc];You found $var[desc] lying on the ocean;You were sliding through the ocean when you saw $var[desc];You noticed $var[desc] on your path]!
