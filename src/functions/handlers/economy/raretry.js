export default {
  ...
  code: `
    ...
    $let[rtMode;$default[$toLowerCase[$default[$option[mode];$message[0]]];$env[userProfile;rtMode]]]
        ...
        $if[$getUserVar[caughtRaresInRaretry]>=$getGlobalVar[maxRaretryRares];
          ...
          $async[
            ...
            $sendMessage[$channelID;
              $addTextDisplay[$tl[ui.special.caughtRares;<@$authorID>;$getGlobalVar[maxRaretryRares];$commandName]]
            ]
          ]
        ]
      ]
