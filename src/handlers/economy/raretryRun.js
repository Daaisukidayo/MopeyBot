  ...
  code: `
    ...
    $arrayMap[generatedLuckEntries;entry;
      ...
      $if[$and[$get[animalID]!=undefined;$get[isRare]];
        ...
        $return[## $get[CL]$get[animalDisplay] | \`$get[numberOfRares]/$get[totalAttempts]\`$get[extra]]
      ]
    ;desc]
        ...
        $if[$getUserVar[caughtRaresInRaretryrun]>=$getGlobalVar[maxRaretryrunRares];
          ...
          $async[
            ...
            $sendMessage[$channelID;
              $addTextDisplay[$tl[ui.special.caughtRares;<@$authorID>;$getGlobalVar[maxRaretryrunRares];$commandName]]
            ]
          ]
        ]
      ]
