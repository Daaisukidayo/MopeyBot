export default { 
  ...
  code: `
    ...
    $let[targetCondition;$and[$get[isDev];$get[arg]!=;$isNumber[$get[arg]];$get[arg]>-1;$get[arg]<=$get[li]]]
    $let[targetID;$if[$get[targetCondition];$get[arg];-1]]
    ...
    $loop[$get[al];
      ...
      $let[condition;$function[
        $if[$get[targetID]==-1;
          $return[$checkCondition[$randomNumber[1;$math[1 + $get[baseChance]]]==1]]
        ;
      ...
      $if[$get[lastDailyRaretry]!=$day;
        $setUserVar[caughtRaresInRaretry;$sum[$getUserVar[caughtRaresInRaretry];1]]
      ...
      $jsonLoad[footer;\\[
        "$tl[ui.raretry.rarity;1;$separate[$get[baseChance]]]",
        "$tl[ui.raretry.category;$get[category]]",
        "$tl[ui.raretry.mode;$tl[data.raretryModes.$get[rtMode]]]"
      \\]]
