    ...
    $switch[$get[IID];
      ...
      $case[showHistory_deletePage;
        ...
        $addContainer[
          ...
          $addActionRow
          $addButton[showHistory_confirmDeletePage-$authorID;$tl[$get[l];ui;history.buttonLabelConfirm];Success;✅]
          $addButton[showHistory_declineDeletePage-$authorID;$tl[$get[l];ui;history.buttonLabelDecline];Danger;❌]
      ...
      $case[showHistory_showPages;
        $modal[showHistory_changePageInModal-$authorID;$tl[$get[l];ui;history.modalTitleMoveToPage]]
        $addTextInput[showHistory_modalInput;$tl[$get[l];ui;history.modalDescriptionMoveToPage];Short;true;;;1;5]
        $showModal
        $stop
      ]
      ...
      $case[showHistory_sortingMenu;
        $if[$and[$get[sortType]==3;$get[rareAnimalId]==null];
          $modal[showHistory_sortByRare-$authorID;$tl[$get[l];ui;history.modalTitleSortByRare]]
          $addTextInput[showHistory_modalInput;$tl[$get[l];ui;history.modalDescriptionSortByRare];Short;true;$tl[$get[l];ui;history.modalPlaceholderSortByRare]]
          $showModal
          $stop
        ]
      ...
      $case[showHistory_filterByRareButton;
        $modal[showHistory_filterByRare-$authorID;$tl[$get[l];ui;history.modalTitleFilterByRare]]
        $addTextInput[showHistory_modalInput;$tl[$get[l];ui;history.modalDescriptionFilterByRare];Short;true;$tl[$get[l];ui;history.modalPlaceholderFilterByRare]]
        $showModal
        $stop
      ]
